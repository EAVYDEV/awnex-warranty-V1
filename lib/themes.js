...
const LIGHT = {
  ...
  '--t-card':            '#FFFFFF',
  '--t-surface':         '#FAFAF8',
  '--t-surface-warm':    '#F5F4F0',
  '--t-border':          '#E5E4E0',
  '--t-border-mid':      '#C4C3BD',
  '--t-sidebar':         '#07244A',
  '--t-sidebar-hover':   '#0D3F72',
  '--t-sidebar-active':  'rgba(255,255,255,0.14)',
  '--t-sidebar-text':    'rgba(255,255,255,0.85)',
  '--t-sidebar-muted':   'rgba(255,255,255,0.45)',
  ...
  '--t-shadow-elevated': '0 4px 16px rgba(0,0,0,0.12)',
  '--t-shadow-brand':    '0 2px 8px rgba(27,95,168,0.30)',
  '--t-shadow-danger':   '0 2px 6px rgba(226,75,74,0.30)',
};
