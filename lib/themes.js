...
const LIGHT = {
  ...
  '--t-shadow-modal':    '0 20px 60px rgba(0,0,0,0.28)',
  '--t-shadow-panel':    '-4px 0 28px rgba(0,0,0,0.14)',
  '--t-shadow-brand':    '0 2px 8px rgba(27,95,168,0.25)',
  '--t-shadow-danger':   '0 2px 6px rgba(226,75,74,0.28)',
  '--t-overlay':         'rgba(7,36,74,0.50)',
  '--t-backdrop':        'rgba(0,0,0,0.22)',
  '--t-toolbar-btn-bg':          'rgba(255,255,255,0.10)',
  '--t-toolbar-btn-border':      'rgba(255,255,255,0.18)',
  '--t-toolbar-btn-border-danger':'rgba(242,95,92,0.4)',
  '--t-toolbar-text':            'rgba(255,255,255,0.88)',
  '--t-toolbar-text-muted':      'rgba(255,255,255,0.80)',
  '--t-toolbar-divider':         'rgba(255,255,255,0.15)',
  '--t-toolbar-badge-bg':        'rgba(255,255,255,0.12)',
  '--t-toolbar-danger':          '#F9A8A8',
};
...
const SLATE = {
  ...
  '--t-overlay':         'rgba(30,41,59,0.60)',
  '--t-backdrop':        'rgba(0,0,0,0.30)',
};
