...
export const colors = {
  ...
  sidebarTextHover:    'var(--t-sidebar-text-hover)',
  sidebarMuted:        'var(--t-sidebar-muted)',
  sidebarBorder:       'var(--t-sidebar-border)',

  // Chart / module semantic palette
  purple:              'var(--t-purple)',
  orange:              'var(--t-orange)',
  pink:                'var(--t-pink)',
  teal:                'var(--t-teal)',
  indigo:              'var(--t-indigo)',
  purpleSubtle:        'var(--t-purple-subtle)',
  purpleText:          'var(--t-purple-text)',
  tealSubtle:          'var(--t-teal-subtle)',
  tealText:            'var(--t-teal-text)',

  // Edit-mode toolbar (always on a dark brandDeep surface)
  toolbarBtnBg:          'var(--t-toolbar-btn-bg)',
  toolbarBtnBorder:      'var(--t-toolbar-btn-border)',
  toolbarBtnBorderDanger:'var(--t-toolbar-btn-border-danger)',
  toolbarText:           'var(--t-toolbar-text)',
  toolbarTextMuted:      'var(--t-toolbar-text-muted)',
  toolbarDivider:        'var(--t-toolbar-divider)',
  toolbarBadgeBg:        'var(--t-toolbar-badge-bg)',
  toolbarDanger:         'var(--t-toolbar-danger)',
};
...
export const T = {
  ...
  warningFill:   colors.warningFill,
  ...
  sidebarTextHover: colors.sidebarTextHover,
  sidebarMuted:     colors.sidebarMuted,
  sidebarBorder:    colors.sidebarBorder,

  // Chart / module palette
  purple:       colors.purple,
  orange:       colors.orange,
  pink:         colors.pink,
  teal:         colors.teal,
  indigo:       colors.indigo,
  purpleSubtle: colors.purpleSubtle,
  purpleText:   colors.purpleText,
  tealSubtle:   colors.tealSubtle,
  tealText:     colors.tealText,

  // Toolbar
  toolbarBtnBg:           colors.toolbarBtnBg,
  toolbarBtnBorder:       colors.toolbarBtnBorder,
  toolbarBtnBorderDanger: colors.toolbarBtnBorderDanger,
  toolbarText:            colors.toolbarText,
  toolbarTextMuted:       colors.toolbarTextMuted,
  toolbarDivider:         colors.toolbarDivider,
  toolbarBadgeBg:         colors.toolbarBadgeBg,
  toolbarDanger:          colors.toolbarDanger,

  // Shadows
  cardShadow:    shadows.card,
  cardHover:     shadows.elevated,
  modalShadow:   shadows.modal,
  panelShadow:   shadows.panel,
  brandGlow:     shadows.brandGlow,
  dangerGlow:    shadows.dangerGlow,

  // Overlays
  overlay:       overlays.modal,
...
export const CHART_PALETTE = [
  ...
  colors.purple, colors.orange, colors.pink, colors.teal, colors.indigo, colors.borderMid,
];
