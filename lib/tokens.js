...
export const radius = {
  ...
  widget:    'var(--t-radius-widget)',
  container: 'var(--t-radius-container)',
  item:      'var(--t-radius-item)',
  input:     'var(--t-radius-input)',
  inputSm:   'var(--t-radius-sm)',
  buttonSm:  'var(--t-radius-sm)',
};

export const shadows = {
  card:       'var(--t-shadow-card)',
  elevated:   'var(--t-shadow-elevated)',
  overlay:    'var(--t-shadow-overlay)',
...
export const T = {
  ...
  overlayShadow: shadows.overlay,
  brandGlow:     shadows.brandGlow,
  dangerGlow:    shadows.dangerGlow,

  // Radius
  radiusCard:      'var(--t-radius-card)',
  radiusWidget:    'var(--t-radius-widget)',
  radiusContainer: 'var(--t-radius-container)',
  radiusItem:      'var(--t-radius-item)',
  radiusInput:     'var(--t-radius-input)',
  radiusSm:        'var(--t-radius-sm)',

  // Typography
  fontSans:        'var(--t-font-sans)',
  fontMono:        'var(--t-font-mono)',
