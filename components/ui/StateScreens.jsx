...
export function EmptyState({ onConfigure }) {
  return (
    <div style={{
      ...
      <div>
        <h2 style={{ fontSize: 17, fontWeight: 700, color: T.brandDarkest, margin: "0 0 6px" }}>
...
QB_TOKEN   your_user_token`}
      ...
      {onConfigure && (
        ...
        >
          <Icon name="settings" size={15} color={T.white} />
...
export function LoadingState() {
  const sk = {
    background: `linear-gradient(90deg, ${T.border} 25%, ${T.bgApp} 50%, ${T.border} 75%)`,
      ...
      <div style={{
        ...
        {[...Array(4)].map((_, i) => (
          <div key={i} style={{
            ...
            padding: "18px 20px", boxShadow: "0 1px 3px rgba(0,0,0,0.07)",
          }}>
