...
const C = colors;
const ACCENT = "#0891B2"; // module-identity color (header bar) — intentionally fixed
...
function ConnectBanner({ onSettings }) {
  return (
    <div style={{ background: T.brandSubtle, border: `1px dashed ${C.brand}`, borderRadius: T.radiusContainer, padding: "20px 24px", marginBottom: 24, display: "flex", alignItems: "center", justifyContent: "space-between", gap: 16 }}>
      <div>
...
const btnStyle = (variant) => ({
  ...
  padding: "7px 14px", borderRadius: T.radiusInput, fontSize: 12, fontWeight: 600,
  cursor: "pointer",
  ...(variant === "outline"
