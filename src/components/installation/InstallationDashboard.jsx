...
export function InstallationDashboard({ jobs }) {
  ...
  return <div>
    ...
    <div style={{ background: T.card, borderRadius: 8, border: `1px solid ${T.borderLight}`, padding: "12px 16px", marginBottom: 16, boxShadow: T.cardShadow, display: "flex", gap: 10, flexWrap: "wrap", alignItems: "center" }}>
      ...
      <div style={{ marginLeft: "auto", display: "flex", background: T.card, border: `1px solid ${T.borderLight}`, borderRadius: 8, overflow: "hidden" }}>
    ...
    {view === "table" && (
      <div style={{ overflow: "auto", borderRadius: 8, border: `1px solid ${T.borderLight}`, boxShadow: T.cardShadow, background: T.card }}>
