    ...
    <div style={{ fontFamily: "'DM Sans', system-ui, sans-serif", background: T.bg, minHeight: standalone ? "100vh" : "auto", padding: "24px 24px 48px" }}>
      ...
      <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", marginBottom: 20, flexWrap: "wrap", gap: 12 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10, flexWrap: "wrap" }}>
          {/* Sync status */}
          {syncStatus !== "loading" && (
            <div style={{ display: "flex", alignItems: "center", gap: 5, padding: "4px 10px", borderRadius: 6, background: T.card, border: `1px solid ${T.borderLight}`, fontSize: 11 }}>
          ...
          {Object.entries(sourceStatuses).map(([id, st]) => (
            <div key={id} style={{ display: "flex", alignItems: "center", gap: 5, padding: "4px 10px", borderRadius: 6, background: T.card, border: `1px solid ${T.borderLight}`, fontSize: 11, color: T.text2 }}>
          ...
          {activeModule === "warranty" && (
            <button
              ...
              style={{ position: "relative", width: 34, height: 34, borderRadius: 6, border: `1px solid ${showAlerts ? T.brand : T.borderLight}`, background: showAlerts ? T.brandSubtle : T.card, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", color: showAlerts ? T.brand : T.text2, boxShadow: T.cardShadow }}
            >
          ...
          <button
            ...
            style={{ width: 34, height: 34, borderRadius: 6, border: `1px solid ${T.borderLight}`, background: T.card, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", color: T.text2, boxShadow: T.cardShadow }}
          >
          ...
          <button
            ...
            style={{ padding: "7px 14px", borderRadius: 6, border: `1px solid ${editMode ? T.brand : T.borderLight}`, background: editMode ? T.brandSubtle : T.card, color: editMode ? T.brand : T.text2, fontSize: 12, fontWeight: 600, cursor: "pointer", display: "flex", alignItems: "center", gap: 5, boxShadow: T.cardShadow }}
          >
          ...
          {/* View toggle */}
          <div style={{ display: "flex", background: T.card, border: `1px solid ${T.borderLight}`, borderRadius: 6, overflow: "hidden", boxShadow: T.cardShadow }}>
      ...
      {/* ── Filter bar ───────────────────────────────────────────────────── */}
      <div style={{ background: T.card, borderRadius: 6, padding: "12px 16px", marginBottom: 20, boxShadow: T.cardShadow, display: "flex", gap: 10, flexWrap: "wrap", alignItems: "center" }}>
        ...
        <button
          ...
          style={{ padding: "7px 12px", borderRadius: 6, border: `1px solid ${showRisingRisk ? T.danger : T.borderLight}`, background: showRisingRisk ? T.dangerSubtle : T.card, color: showRisingRisk ? T.dangerText : T.text2, fontSize: 12, fontWeight: 600, cursor: "pointer", display: "flex", alignItems: "center", gap: 5, whiteSpace: "nowrap", flexShrink: 0 }}
        >
        ...
        {hasFilters && (
          <button onClick={() => { setSearch(""); setFieldFilters({}); setShowRisingRisk(false); }} style={{ padding: "8px 12px", borderRadius: 6, border: `1px solid ${T.dangerSubtle}`, background: T.dangerSubtle, color: T.danger, fontSize: 12, fontWeight: 600, cursor: "pointer", whiteSpace: "nowrap" }}>
            Clear Filters
          </button>
        )}
      ...
      {activeView === "table" && (
        <div style={{ background: T.card, borderRadius: 6, boxShadow: T.cardShadow, overflow: "hidden" }}>
          {showColumnEditor && (
            <ColumnEditor
          ...
          <div style={{ padding: "14px 20px", borderBottom: `1px solid ${T.borderLight}`, display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12, flexWrap: "wrap" }}>
            ...
            <div style={{ display: "flex", gap: 12, alignItems: "center" }}>
              ...
              <button
                ...
                style={{ padding: "5px 12px", borderRadius: 6, border: `1px solid ${T.borderLight}`, background: T.surface, color: T.text2, fontSize: 12, fontWeight: 600, cursor: "pointer", display: "flex", alignItems: "center", gap: 5 }}
              >
